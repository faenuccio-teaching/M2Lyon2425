...
example (S T : Set Ω) (hS : μ S ≠ ∞) (hT : MeasurableSet T) :
  ...
  refine ENNReal.eq_sub_of_add_eq ?hc ?_
  exact ne_top_of_le_ne_top hS (OuterMeasureClass.measure_mono μ Set.inter_subset_left)
  exact measure_union_add_inter S hT
...
example
  ...
  · rw [EventuallyLE, ae_restrict_iff]
    ...
    exact le_of_lt ha
    sorry
  · exact Integrable.integrableOn hint
  · sorry
